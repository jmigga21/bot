...
def settings_inl():
    ...
    if rules is None or rules == "-" or rules == "None":
        rules_emoji = "❌"
    else:
        rules_emoji = "✅"
    ...
    kb.append(InlineKeyboardButton(f"RULES | {rules_emoji}", callback_data="rules:edit"))
    kb.append(InlineKeyboardButton(f"Поддержка | {faq_emoji}", callback_data="faq:edit"))
    kb.append(InlineKeyboardButton(f"Отзывы | {sup_emoji}", callback_data="sup:edit"))
    kb.append(InlineKeyboardButton(f"Отзывы (ссылка) | {chat_emoji}", callback_data="chat:edit"))
...
def products_edits():
    ...
    kb.append(InlineKeyboardButton("➕ | Город", callback_data=f"add_cat"))
    kb.append(InlineKeyboardButton("⚙️ | Город", callback_data=f"edit_cat"))
    kb.append(InlineKeyboardButton("🗑️ | ВСЕ Города", callback_data=f"del_all_cats"))

    kb.append(InlineKeyboardButton("➕ | Район", callback_data=f"add_pod_cat"))
    kb.append(InlineKeyboardButton("⚙️ | Район", callback_data=f"edit_pod_cat"))
    kb.append(InlineKeyboardButton("🗑️ | ВСЕ Районы", callback_data=f"del_all_pod_cats"))
...
def open_pod_cats_for_add_pos(cat_id):
    ...
    keyboard.add(InlineKeyboardButton(f"🏙 Выбрать этот город", callback_data=f"add_poss_cat:{cat_id}"))
