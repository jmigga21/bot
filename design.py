...
start_photo = 'https://img2.teletype.in/files/9c/41/9c41551b-2c0e-4a95-a934-a7088e261503.jpeg'

# Стартовый текст
start_text = """
👋 Приветствуем, @{user_name}! 

<b>Внимательно ознакомтесь с правилами</b>, прежде чем совершать покупку ❗️
...
no_rules_text = "<b>⚙️ rules Не было настроено, обратитесь в поддержку!</b>"
no_faq_text = "<b>⚙️ FAQ Не было настроено, обратитесь в поддержку!</b>"
faq_chat_inl = "📲 Написать оператору"
...
yes_support = "<b>Чтобы оставить отзыв, напишите оператору❗️\n\nЧтобы перейти к отзывам нажмите на кнопку снизу:</b>"
...
no_cats = f"<b>К сожалению в данный момент нет городов :(</b>"
available_cats = f"<b>📍 Выберите город:</b>"
current_cat = "<b>📍 Выбран город: <code>{name}</code>\n\n↘️ Выберите район:</b>"
...
current_pod_cat = "<b>🏡 Выбран район: <code>{name}</code></b>"
